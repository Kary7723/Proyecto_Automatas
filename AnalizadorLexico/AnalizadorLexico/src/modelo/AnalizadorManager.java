...
private static final Pattern PATRON_BOOLEANO = Pattern.compile("true|false");
    ...
    private static final Pattern PATRON_REAL = Pattern.compile(N + "*\\." + N + "+");
    private static final Pattern PATRON_REAL_CIENTIFICO = Pattern.compile(N + "*\\." + N + "+[eE][+-]?" + N + "+");
    private static final Pattern PATRON_FECHA = Pattern.compile(N + "{2}/" + N + "{2}/" + N + "{4}");
    private static final Pattern PATRON_IDENTIFICADOR = Pattern.compile("(" + L + "|_)(" + L + "|" + N + "|_)*");
    ...
    if (PATRON_ENTERO.matcher(token).matches()) {
    ...
    } else if (PATRON_REAL_CIENTIFICO.matcher(token).matches()) {
